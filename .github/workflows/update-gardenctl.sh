...
class Gardenctl < Formula
  ...
  if OS.mac?
    url "https://github.com/gardener/gardenctl/releases/download/$1/gardenctl-darwin-amd64"
    sha256 "$sha"
  elsif OS.linux?
    url "https://github.com/gardener/gardenctl/releases/download/$1/gardenctl-linux-amd64"
    sha256 "$sha"
  end
